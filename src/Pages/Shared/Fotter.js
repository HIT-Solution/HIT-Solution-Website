      ...
      <footer id="footer" className="footer">
        ...
        <div className="container mt-4">
          <div className="copyright">
            &copy; Copyright <strong><span>Hasan's IT Solution</span></strong>. All Rights Reserved
          </div>
          <div className="credits">
            Designed by <a className='text-decoration-none' href="https://bootstrapmade.com/">sakhawathosen</a>
          </div>
        </div>
      </footer>
